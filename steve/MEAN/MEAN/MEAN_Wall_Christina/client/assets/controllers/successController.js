app.controller('successController', ['$scope', 'usersFactory', '$location', '$cookies', 'messagesFactory', 'commentsFactory', function($scope, usersFactory, $location, $cookies, messagesFactory, commentsFactory){
	$scope.users=[];
	$scope.user={};
